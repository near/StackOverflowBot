...
# The bot uses Endpoint URL's to send messages. Find our more here: https://slack.com/help/articles/115005265063-Incoming-webhooks-for-Slack
...
thirtyMinsAgo = currenttime - 3600 #rewind 60 minutes since that's the frequency the job run's at.
